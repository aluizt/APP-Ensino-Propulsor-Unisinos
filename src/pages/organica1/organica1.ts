...
@IonicPage()
@Component({
  selector: 'page-organica1',
  templateUrl: 'organica1.html',
  providers: [ScreenOrientation]
})
export class Organica1Page {
  ...
  ionViewDidLoad() {
    console.log('ionViewDidLoad Organica1Page');
    ...
    for (var j=0; j<this.auxiliar2.length; ++j){
         ...
         if(this.auxiliar == 1 && this.auxiliar2[j].descricao == "OrganicaI"){ 
