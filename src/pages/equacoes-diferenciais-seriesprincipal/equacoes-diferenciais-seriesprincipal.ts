...
import { EquacoesDiferenciaisSeriesPage } from '../equacoes-diferenciais-series/equacoes-diferenciais-series';

@IonicPage()
@Component({
  selector: 'page-equacoes-diferenciais-seriesprincipal',
  templateUrl: 'equacoes-diferenciais-seriesprincipal.html',
  providers: [ScreenOrientation]
})
export class EquacoesDiferenciaisSeriesprincipalPage {
  ...
  ionViewDidLoad() {
    console.log('ionViewDidLoad EquacoesDiferenciaisSeriesprincipalPage');
   ...
   console.log("monitorias Equacoes diferenciais e series ");
  ...
  goToEquacoesDiferenciaisSeries(){
    this.navCtrl.push(EquacoesDiferenciaisSeriesPage);
  }
}
