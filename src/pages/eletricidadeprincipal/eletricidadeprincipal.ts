...
import { EletricidadePage } from '../eletricidade/eletricidade';

@IonicPage()
@Component({
  selector: 'page-eletricidadeprincipal',
  templateUrl: 'eletricidadeprincipal.html',
  providers: [ScreenOrientation]
})
export class EletricidadeprincipalPage {
  ...
  ionViewDidLoad() {
    ...
    for(var i=0; i <this.monitoria.length; ++i){
      if(this.monitoria[i].descricao == "Eletricidade" && this.monitoria[i].campus == 1){
  ...
  goToEletricidade(){
    this.navCtrl.push(EletricidadePage);
  }
