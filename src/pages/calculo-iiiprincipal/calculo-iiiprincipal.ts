...
import { CalculoIiiPage } from '../calculo-iii/calculo-iii';

@IonicPage()
@Component({
  selector: 'page-calculo-iiiprincipal',
  templateUrl: 'calculo-iiiprincipal.html',
  providers: [ScreenOrientation]
})
export class CalculoIiiprincipalPage {
  ...
  ionViewDidLoad() {
    console.log('ionViewDidLoad CalculoIiiprincipalPage');
    ...
    for(var i=0; i <this.monitoria.length; ++i){
      if(this.monitoria[i].descricao == "CalculoIII" && this.monitoria[i].campus == 1){
   ...
   console.log("monitorias Calculo III");
  ...
  goToCalculoIII(){
    this.navCtrl.push(CalculoIiiPage);
  }
}
