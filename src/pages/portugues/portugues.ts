...
@IonicPage()
@Component({
  selector: 'page-portugues',
  templateUrl: 'portugues.html',
  providers: [ScreenOrientation]
})
export class PortuguesPage {
  ...
  ionViewDidLoad() {
    console.log('ionViewDidLoad PortuguesPage');
    ...
    for (var j=0; j<this.auxiliar2.length; ++j){
         ...
         if(this.auxiliar == 1 && this.auxiliar2[j].descricao == "Portugues"){  // se o campus for são leopoldo
