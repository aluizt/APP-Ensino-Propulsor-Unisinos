...
@IonicPage()
@Component({
  selector: 'page-organica2',
  templateUrl: 'organica2.html',
  providers: [ScreenOrientation]
})
export class Organica2Page {
  ...
  ionViewDidLoad() {
    console.log('ionViewDidLoad Organica2Page . ');
    ...
    for (var j=0; j<this.auxiliar2.length; ++j){
         ...
         if(this.auxiliar == 1 && this.auxiliar2[j].descricao == "OrganicaII"){ 
