...
import { EquacoesDiferenciaisPage } from '../equacoes-diferenciais/equacoes-diferenciais';

@IonicPage()
@Component({
  selector: 'page-equacoes-diferenciaisprincipal',
  templateUrl: 'equacoes-diferenciaisprincipal.html',
  providers: [ScreenOrientation]
})
export class EquacoesDiferenciaisprincipalPage {
  ...
  ionViewDidLoad() {
    console.log('ionViewDidLoad EquacoesDiferenciaisprincipalPage');
   ...
   console.log("monitorias Equacoes diferenciais ");
  ...
  goToEquacoesDiferenciais(){
    this.navCtrl.push(EquacoesDiferenciaisPage);
  }
}
