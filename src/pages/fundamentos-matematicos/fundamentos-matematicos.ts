...
@IonicPage()
@Component({
  selector: 'page-fundamentos-matematicos',
  templateUrl: 'fundamentos-matematicos.html',
  providers: [ScreenOrientation]
})
export class FundamentosMatematicosPage {
  ...
  ionViewDidLoad() {
    console.log('ionViewDidLoad FundamentosMatematicosPage');
    ...
    for (var j=0; j<this.auxiliar2.length; ++j){
         ...
         if(this.auxiliar == 1 && this.auxiliar2[j].descricao == "Fundamentos"){  // se o campus for são leopoldo
