...
@IonicPage()
@Component({
  selector: 'page-variaveis-complexas',
  templateUrl: 'variaveis-complexas.html',
  providers: [ScreenOrientation]
})
export class VariaveisComplexasPage {
  ...
  ionViewDidLoad() {
    console.log('ionViewDidLoad VariaveisComplexasPage');
    ...
    for (var j=0; j<this.auxiliar2.length; ++j){
         ...
         if(this.auxiliar == 1 && this.auxiliar2[j].descricao == "VariaveisC"){ 
