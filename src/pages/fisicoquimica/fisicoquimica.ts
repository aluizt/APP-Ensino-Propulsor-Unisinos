...
@IonicPage()
@Component({
  selector: 'page-fisicoquimica',
  templateUrl: 'fisicoquimica.html',  
  providers: [ScreenOrientation]
})
export class FisicoquimicaPage {
  ...
  ionViewDidLoad() {
    console.log('ionViewDidLoad FisicoquimicaPage');
    ...
    for (var j=0; j<this.auxiliar2.length; ++j){
         ...
         if(this.auxiliar == 1 && this.auxiliar2[j].descricao == "FisicoQ"){  // se o campus for são leopoldo
