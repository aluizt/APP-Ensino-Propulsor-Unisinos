...
@IonicPage()
@Component({
  selector: 'page-calculo-iii',
  templateUrl: 'calculo-iii.html',
  providers: [ScreenOrientation]
})
export class CalculoIiiPage {
  ...
  ionViewDidLoad() {
    console.log('ionViewDidLoad CalculoIIIPage');
    ...
    for (var j=0; j<this.auxiliar2.length; ++j){
         ...
         if(this.auxiliar == 1 && this.auxiliar2[j].descricao == "CalculoIII"){  
