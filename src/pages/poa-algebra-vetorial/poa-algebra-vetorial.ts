...
@IonicPage()
@Component({
  selector: 'page-poa-algebra-vetorial',
  templateUrl: 'poa-algebra-vetorial.html',
  providers: [ScreenOrientation]
})
export class PoaAlgebraVetorialPage {
  ...
  ionViewDidLoad() {
    console.log('ionViewDidLoad PoaAlgebraVetorialPage');
    ...
    for (var j=0; j<this.auxiliar2.length; ++j){
         ...
         if(this.auxiliar == 2 && this.auxiliar2[j].descricao == "AlgebraV"){ 
