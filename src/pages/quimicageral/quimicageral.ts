...
@IonicPage()
@Component({
  selector: 'page-quimicageral',
  templateUrl: 'quimicageral.html',
  providers: [ScreenOrientation]
})
export class QuimicageralPage {
  ...
  ionViewDidLoad() {
    console.log('ionViewDidLoad QuimicageralPage');
    ...
    for (var j=0; j<this.auxiliar2.length; ++j){
         ...
         if(this.auxiliar == 1 && this.auxiliar2[j].descricao == "QuimicaG"){ 
