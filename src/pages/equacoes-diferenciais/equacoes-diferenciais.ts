...
@IonicPage()
@Component({
  selector: 'page-equacoes-diferenciais',
  templateUrl: 'equacoes-diferenciais.html',
  providers: [ScreenOrientation]
})
export class EquacoesDiferenciaisPage {
  ...
  ionViewDidLoad() {
    console.log('ionViewDidLoad EquacoesDiferenciaisPage');
    ...
    for (var j=0; j<this.auxiliar2.length; ++j){
         ...
         if(this.auxiliar == 1 && this.auxiliar2[j].descricao == "EquacoesD"){  
