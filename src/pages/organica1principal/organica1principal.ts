...
import { Organica1Page } from '../organica1/organica1';

@IonicPage()
@Component({
  selector: 'page-organica1principal',
  templateUrl: 'organica1principal.html',
  providers: [ScreenOrientation]
})
export class Organica1principalPage {
  ...
  ionViewDidLoad() {
    console.log('ionViewDidLoad Organica1principalPage');
    ...
    for(var i=0; i <this.monitoria.length; ++i){
      if(this.monitoria[i].descricao == "OrganicaI" && this.monitoria[i].campus == 1){
   ...
   console.log("monitorias Quimica Organica I");
  ...
  goToOrganicaI(){
    this.navCtrl.push(Organica1Page);
  }
