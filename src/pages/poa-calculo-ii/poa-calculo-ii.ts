...
@IonicPage()
@Component({
  selector: 'page-poa-calculo-ii',
  templateUrl: 'poa-calculo-ii.html',
  providers: [ScreenOrientation]
})
export class PoaCalculoIiPage {
  ...
  ionViewDidLoad() {
    console.log('ionViewDidLoad PoaCalculoIiPage');
    ...
    for (var j=0; j<this.auxiliar2.length; ++j){
         ...
         if(this.auxiliar == 2 && this.auxiliar2[j].descricao == "CalculoII"){ 
