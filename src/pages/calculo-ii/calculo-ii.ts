...
@IonicPage()
@Component({
  selector: 'page-calculo-ii',
  templateUrl: 'calculo-ii.html', 
  providers: [ScreenOrientation]
})
export class CalculoIiPage {
  ...
  ionViewDidLoad() {
    console.log('ionViewDidLoad CalculoIIPage');
    ...
    for (var j=0; j<this.auxiliar2.length; ++j){
         ...
         if(this.auxiliar == 1 && this.auxiliar2[j].descricao == "CalculoII"){  
