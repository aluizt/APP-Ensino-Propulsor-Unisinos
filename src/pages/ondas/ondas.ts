...
@Component({
  selector: 'page-ondas',
  templateUrl: 'ondas.html',
  providers: [ScreenOrientation]
})
export class OndasPage {
  ...
  ionViewDidLoad() {
    console.log('ionViewDidLoad OndasPage');
    ...
    for (var j=0; j<this.auxiliar2.length; ++j){
         ...
         if(this.auxiliar == 1 && this.auxiliar2[j].descricao == "Ondas"){  // se o campus for são leopoldo
