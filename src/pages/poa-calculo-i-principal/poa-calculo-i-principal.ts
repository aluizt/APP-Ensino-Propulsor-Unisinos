...
@IonicPage()
@Component({
  selector: 'page-poa-calculo-i-principal',
  templateUrl: 'poa-calculo-i-principal.html',
  providers: [ScreenOrientation]
})
export class PoaCalculoIPrincipalPage {
  ...
  ionViewDidLoad() {
    console.log('ionViewDidLoad PoaCalculoIPrincipalPage');
    ...
    for(var i=0; i <this.monitoria.length; ++i){
      if(this.monitoria[i].descricao == "CalculoI" && this.monitoria[i].campus == 2){
   ...
   console.log("monitorias Calculo I");
