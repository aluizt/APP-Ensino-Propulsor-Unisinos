...
@IonicPage()
@Component({
  selector: 'page-mecanica-b',
  templateUrl: 'mecanica-b.html',
  providers: [ScreenOrientation]
})
export class MecanicaBPage {
  ...
  ionViewDidLoad() {
    ...
    for (var j=0; j<this.auxiliar2.length; ++j){
         ...
         if(this.auxiliar == 1 && this.auxiliar2[j].descricao == "Mecanica B"){  // se o campus for são leopoldo
