...
@IonicPage()
@Component({
  selector: 'page-calculo-varias-variaveis',
  templateUrl: 'calculo-varias-variaveis.html',
  providers: [ScreenOrientation]
})
export class CalculoVariasVariaveisPage {
  ...
  ionViewDidLoad() {
    console.log('ionViewDidLoad CalculoVariasVariaveisPage');
    ...
    for (var j=0; j<this.auxiliar2.length; ++j){
         ...
         if(this.auxiliar == 1 && this.auxiliar2[j].descricao == "CalculoV"){  
