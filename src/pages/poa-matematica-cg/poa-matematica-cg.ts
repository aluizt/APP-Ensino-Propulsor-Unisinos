...
@IonicPage()
@Component({
  selector: 'page-poa-matematica-cg',
  templateUrl: 'poa-matematica-cg.html',
  providers: [ScreenOrientation]
})
export class PoaMatematicaCgPage {
  ...
  ionViewDidLoad() {
    console.log('ionViewDidLoad PoaMatematicaCgPage');
    ...
    for (var j=0; j<this.auxiliar2.length; ++j){
         ...
         if(this.auxiliar == 2 && this.auxiliar2[j].descricao == "MatematicaCG"){ 
