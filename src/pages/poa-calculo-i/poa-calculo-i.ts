...
@IonicPage()
@Component({
  selector: 'page-poa-calculo-i',
  templateUrl: 'poa-calculo-i.html',
  providers: [ScreenOrientation]
})
export class PoaCalculoIPage {
  ...
  ionViewDidLoad() {
    console.log('ionViewDidLoad PoaCalculoIPage');
    ...
    for (var j=0; j<this.auxiliar2.length; ++j){
         ...
         if(this.auxiliar == 2 && this.auxiliar2[j].descricao == "CalculoI"){ 
