...
import { OndasPage } from '../ondas/ondas';

@IonicPage()
@Component({
  selector: 'page-ondasprincipal',
  templateUrl: 'ondasprincipal.html',
  providers: [ScreenOrientation]
})
export class OndasprincipalPage {
  ...
  ionViewDidLoad() {
    console.log('ionViewDidLoad OndasprincipalPage');
    ...
    for(var i=0; i <this.monitoria.length; ++i){
      if(this.monitoria[i].descricao == "Ondas" && this.monitoria[i].campus == 1){
