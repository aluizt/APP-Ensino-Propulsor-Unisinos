...
@IonicPage()
@Component({
  selector: 'page-eletricidade',
  templateUrl: 'eletricidade.html',
  
  providers: [ScreenOrientation]
})
export class EletricidadePage {
  ...
  ionViewDidLoad() {
    console.log('ionViewDidLoad EletricidadePage');
    ...
    for (var j=0; j<this.auxiliar2.length; ++j){
         ...
         if(this.auxiliar == 1 && this.auxiliar2[j].descricao == "Eletricidade"){  // se o campus for são leopoldo
