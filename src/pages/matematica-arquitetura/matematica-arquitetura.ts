...
@IonicPage()
@Component({
  selector: 'page-matematica-arquitetura',
  templateUrl: 'matematica-arquitetura.html',
  providers: [ScreenOrientation]
})
export class MatematicaArquiteturaPage {
  ...
  ionViewDidLoad() {
    console.log('ionViewDidLoad MatematicaArquiteturaPage');
    ...
    for (var j=0; j<this.auxiliar2.length; ++j){
         ...
         if(this.auxiliar == 1 && this.auxiliar2[j].descricao == "MatematicaArq"){  // se o campus for são leopoldo
