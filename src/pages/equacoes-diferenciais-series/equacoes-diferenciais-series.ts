...
@IonicPage()
@Component({
  selector: 'page-equacoes-diferenciais-series',
  templateUrl: 'equacoes-diferenciais-series.html',
  providers: [ScreenOrientation]
})
export class EquacoesDiferenciaisSeriesPage {
  ...
  ionViewDidLoad() {
    console.log('ionViewDidLoad EquacoesDiferenciaisSeriesPage');
    ...
    for (var j=0; j<this.auxiliar2.length; ++j){
         ...
         if(this.auxiliar == 1 && this.auxiliar2[j].descricao == "EquacoesDS"){  
