...
@IonicPage()
@Component({
  selector: 'page-calculo-i',
  templateUrl: 'calculo-i.html',  
  providers: [ScreenOrientation]
})

export class CalculoIPage {
  ...
  ionViewDidLoad() {
    console.log('ionViewDidLoad CalculoIPage');
    ...
    for (var j=0; j<this.auxiliar2.length; ++j){
         ...
         if(this.auxiliar == 1 && this.auxiliar2[j].descricao == "CalculoI"){  
